...
public class Menus {
    ...
    public static final String AZUL = "\u001B[34m";
		...
		public static boolean iniciarSesion(String rol) {
	        Scanner sc = new Scanner(System.in);
	        boolean loginExitoso = false;
	        String contraseniaCorrecta = rol.equals("2") ? "8888" : "1234";
	        String tipoUsuario = rol.equals("2") ? "EMPLEADO" : "CLIENTE";
	        
	        System.out.println(Reserva_Cine.CYAN + "\n===========================================================" + Reserva_Cine.RESET);
	        System.out.println(Reserva_Cine.AZUL + "         INICIO DE SESIÓN - MODO " + tipoUsuario + "         " + Reserva_Cine.RESET);
	        ...
	        if (contrasenia.equals(contraseniaCorrecta)) {
	            System.out.println(Reserva_Cine.VERDE + "\n ¡Bienvenido/a " + usuario + "! Acceso concedido como " + tipoUsuario + "." + Reserva_Cine.RESET);
	            loginExitoso = true;
	        } else {
	    ...
	    public static String menuPeli() { 
	        ...
	        System.out.println(Reserva_Cine.CYAN + "\n┌─────────────────────────────────────────────────────────┐" + Reserva_Cine.RESET);
	        System.out.println(Reserva_Cine.CYAN + "│" + Reserva_Cine.CYAN + "                PELÍCULAS DISPONIBLES                  " + Reserva_Cine.CYAN + "│" + Reserva_Cine.RESET);
	        System.out.println(Reserva_Cine.CYAN + "├─────────────────────────────────────────────────────────┤" + Reserva_Cine.RESET);
	    ...
	    public static String mostrarHorarios(String pelicula) {
	        ...
	        System.out.println(Reserva_Cine.CYAN + "\n┌─────────────────────────────────────────────────────────┐" + Reserva_Cine.RESET);
	        System.out.println(Reserva_Cine.CYAN + "│" + Reserva_Cine.AZUL + "               ⏰ HORARIOS DISPONIBLES                   " + Reserva_Cine.CYAN + "│" + Reserva_Cine.RESET);
	        System.out.println(Reserva_Cine.CYAN + "├─────────────────────────────────────────────────────────┤" + Reserva_Cine.RESET);
